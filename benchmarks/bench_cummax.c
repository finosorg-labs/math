...
static void bench_cummax_f64_func(void* user_data) {
    bench_cummax_ctx_t* ctx = (bench_cummax_ctx_t*)user_data;
    fc_math_cummax_f64(ctx->input, ctx->output, ctx->n);
}

static void bench_cummax_f32_func(void* user_data) {
    bench_cummax_ctx_t* ctx = (bench_cummax_ctx_t*)user_data;
    fc_math_cummax_f32((float*)ctx->input, (float*)ctx->output, ctx->n);
}
...
void bench_cummax_run(void) {
    run_bench_cummax_f64("cummax_f64[n=100]", 100);
    run_bench_cummax_f64("cummax_f64[n=1000]", 1000);
    run_bench_cummax_f64("cummax_f64[n=10000]", 10000);
    run_bench_cummax_f64("cummax_f64[n=100000]", 100000);
    run_bench_cummax_f32("cummax_f32[n=1000]", 1000);
}
