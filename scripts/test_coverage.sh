...
if [ ! -f "$BUILD_DIR/tests/math_tests" ]; then
    echo "Error: Test binary not found at $BUILD_DIR/tests/math_tests"
    ...
    echo "  cmake --build $BUILD_DIR --target math_tests"
    exit 1
fi
...
echo ""
echo "============================================================"
echo "Coverage Report - math Module"
echo "============================================================"
echo ""
